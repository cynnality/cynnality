...
# Parse both files
overall = parse_standings('jul19-jul29-w-ovrall-rankings.html', 'overallRanking')
conference = parse_conference_standings('jul19-jul29-conf-rankings.html')
...
# Save to JSON
with open('jul19-w-rankings.json', 'w', encoding='utf-8') as f:
